...
export default function Solutions() {
  ...
  return (
    <>
      <SEO 
        title="Our Solutions | Lasthash Software Solutions"
        description="Explore our innovative technology solutions including enterprise software, AI/ML, blockchain, and IoT solutions."
        keywords="enterprise solutions, digital transformation, AI solutions, ML solutions, blockchain solutions, IoT solutions"
        canonical="/solutions"
      />
      ...
      <MainLayout>
        ...
        {/* Solutions Sections */}
        {Object.entries(services.solutions.sections).map(([key, section], sectionIndex) => (
          <Box
            key={key}
            sx={{
              position: 'relative',

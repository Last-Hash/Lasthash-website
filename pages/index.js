...
const Home = () => {
  return (
    <>
      ...
      <section
        className="hero-banner background-contain min-vh-100 d-flex align-items-center justify-content-center w-100"
              ...
              <div className="row">
                <div className="col-sm-12 col-lg-8 ml-auto mr-auto text-center">
                  ...
                  <h2 className="hero-title">
                    Datasci is the best modern data analysis agency in Spain
                  </h2>
                  <a href="/contact-us" className="btn btn-bg btn-radius">
                    Contact us <i className="fal fa-long-arrow-alt-right"></i>
                  </a>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-img">
                <img
                  src="/img/researchers-team-work.jpg"
                  alt="researchers-team-work"
                  className="img-fluid"
                />
              ...
              <div className="row">
                <div className="col-sm-12">
                  <div className="section-header text-left">
                    ...
                    <h2 className="section-title">
                      Sophisticated big data agency in USA, India & Europe
                    </h2>
                  </div>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-sm-12">
              <div className="section-header text-center">
                ...
                <h2 className="section-title">
                  We process every single data very carefully. All our staffs
                  are skilled
                </h2>
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-md-4 mt-xs-45">
                  <div className="process-illustration d-none d-md-block">
                    <img
                      src="/img/process-illustration.svg"
          ...
          <div className="row">
            <div className="col-sm-12">
              <div className="section-header text-center">
                ...
                <h2 className="section-title">
                  We do all types of data & science related work efficiently
                </h2>
              </div>
            </div>
          </div>
            ...
            <div className="col-sm-12">
              <div className="tabs-block">
                <ul className="tabs-list nav justify-content-center">
                  <li className="active">
                    <a href="#tab-1">Design & Strategy</a>
                  </li>
                  <li className="">
                    <a href="#tab-2">AI Development</a>
                  </li>
                  <li className="">
                    <a href="#tab-3">Cloud development</a>
                  </li>
                  <li className="">
                    <a href="#tab-4">Security Ensure</a>
                  </li>
                </ul>
      ...
      <section
        ...
        data-background="/img/counter-bg.jpg"
      >
        <div className="container">
          <div className="row">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="section-header text-left">
                ...
                <h2 className="section-title">
                  Our Dedicated team members do every single case professionally
                </h2>
              </div>
            </div>
            <div className="col-lg-6">
              <div id="filters" className="button-group">
                ...
                <button className="button" data-filter=".data">
                  Data
                </button>
                <button className="button" data-filter=".cloud">
                  cloud
                </button>
                <button className="button" data-filter=".startup">
                  startup
                </button>
                <button className="button" data-filter=".big">
                  Big data
                </button>
              </div>
            </div>
          ...
          <div className="row mt-xs-45">
            <div className="col-sm-12">
              <div className="row grid">
                <div
                  className="col-md-4 element-item transition data"
                ...
                >
                  <div className="case-block">
                    <div className="case-image">
                      ...
                      <img
                        src="/img/case-data-analysis.svg"
                        alt="data"
                        className="img-fluid"
                      />
                    </div>
                    <div className="case-content">
                      <h4 className="case-block-title">
                ...
                <div
                  className="col-md-4 element-item transition cloud"
                  data-category="transition"
                >
                  <div className="case-block">
                    <div className="case-image">
                      ...
                      <img
                        src="/img/case-data-modeling.svg"
                        alt="data"
                        className="img-fluid"
                      />
                    </div>
                ...
                <div
                  className="col-md-4 element-item transition startup"
                  data-category="transition"
                >
                  <div className="case-block">
                    <div className="case-image">
                ...
                <div
                  className="col-md-4 element-item transition mining"
                  data-category="transition"
                >
                  <div className="case-block">
                    <div className="case-image">
                ...
                <div
                  className="col-md-4 element-item transition big"
                  data-category="transition"
                >
                  <div className="case-block">
                    <div className="case-image">
      ...
      <section
        className="testimonials-section ptb-100"
        data-background="/img/testimonial-bg.png"
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              <div className="section-header text-left">
                <span className="section-heading color-white">
                  Testimonials
                </span>
                <h2 className="section-title color-white">
                  Our clients are very satisfied and pleasure for our provided
                  services
                </h2>
              </div>
            </div>
                ...
                <div className="testimonial-content">
                  <div className="testimonial-slider owl-carousel owl-theme">
                    <div className="testimonial-inner-content">
                      <p>
                        One of the cloud computing service I have ever used.
                        Always I assigned my stuffs to them. They are very
                        innovative and accurate. Thanks all. Highly recommended
                      </p>
                    ...
                    <div className="testimonial-inner-content">
                      <p>
                        One of the cloud computing service I have ever used.
                        They are very innovative and accurate. Thanks all.
                        Highly recommended
                      </p>
                      <div className="reviewer-meta d-flex align-items-center">
                        <div className="reviewer-img">
                ...
                <div className="post-carousel owl-carousel owl-theme">
                  <div className="post-block-item">
                    ...
                    <div className="post-content">
                      <h2 className="post-block-title">
                        <a href="single.html">
                          Circuit board connected with direct AI & internet
                        </a>
                      </h2>
                    </div>
                    <div className="post-block-footer d-flex justify-content-between align-items-center">
                      <div className="d-flex align-items-center">
                        <div className="post-block-author-photo">
                          <img
                            src="/img/post-author.png"
                            alt="author"
                            className="img-fluid"
                          />
                        </div>
                        <span className="post-block-author-name">
                          Nicky Masou
                        </span>
                      </div>
                  ...
                  <div className="post-block-item">
                    ...
                    <div className="post-content">
                      <h2 className="post-block-title">
                        <a href="single.html">
                          Mecal science is developing human gens
                        </a>
                      </h2>
                    </div>
                    <div className="post-block-footer d-flex justify-content-between align-items-center">
                  ...
                  <div className="post-block-item">
                    ...
                    <div className="post-content">
                      <h2 className="post-block-title">
                        <a href="single.html">
                          Discussiong with colleagues might change life
                        </a>
                      </h2>
                    </div>
                    <div className="post-block-footer d-flex justify-content-between align-items-center">

...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>Machine Learning (ML) Developmentp</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <h1 class="page-title">Machine Learning (ML) Developmentp</h1>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Machine Learning (ML) Developmentp</li>
            </ol>
          </nav>
        </div>
      </div>

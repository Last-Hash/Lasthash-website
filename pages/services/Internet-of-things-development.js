...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>Internet of Things (IoT) Development</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <h1 class="page-title">Internet of Things (IoT) Development</h1>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Internet of Things (IoT) Development</li>
            </ol>
          </nav>
        </div>
      </div>
